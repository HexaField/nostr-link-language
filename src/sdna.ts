/**
 * SDNA / Subject Class pattern detection for Nostr rendering.
 *
 * Detects known Subject Class patterns in LinkExpressions for smart
 * content rendering. Enables chat messages, replies, mentions, and
 * reactions to be translated into appropriate Nostr event kinds.
 *
...
/**
 * Check if a detected pattern should produce a social Nostr event
 * (kind 1, 7, etc.) in addition to the triple event.
 */
